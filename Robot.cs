...
namespace Karesz
{
	partial class Form1
	{
		class Robot
		{
			...
			public static bool játék_megy = false;
			public static bool steppel = false;
			public static bool játék_elindult = false;
			...
			public static void Játék(int akció)
			{
				Thread játék = new Thread(delegate ()
				{
					...
					Robot.form.Frissít();
					SendKeys.SendWait("%"); // valamilyen misztikus okból kifolyólag nem frissít rendesen az ablak a végén, csak ha valaki az ALT gombot lenyomja...
